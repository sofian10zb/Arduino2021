...
//********** Variables ************************************************************
const int ledPin[] = {5, 6, 7, 8, 9, 10, 11, 12};   // donar nom en un array als pins 5, 6, 7, 8, 9, 10, 11, 11, 12
...
void loop()
{
  ...
  { 
    ...
    if (num == 254)       // quan ja ha ensenyat el 15 tornar al 0  
           {
              num = 0;
           }    
