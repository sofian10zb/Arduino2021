...
//int beats[] = { 2,2,4,2,2,4,2,2,3,1,8,2,2,3,1,2,2,2,1,2,2,2,2,4,4,2,2,4,2,2,4,2,2,3,1,8,2,2,2,2,2,2,2,1,2,2,2,2,8};


//Melody 4
int length = 24;
char notes[] = "ggagCbggagDCcegeCbaffecd º";
int beats[] = { 1,1,2,2,2,4,1,1,2,2,2,4,1,1,2,2,2,2,2,1,1,2,2,2};
